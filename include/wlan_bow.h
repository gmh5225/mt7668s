...
wlanoidSendSetQueryBowCmd(IN P_ADAPTER_T prAdapter, UINT_8 ucCID, IN UINT_8 ucBssIdx, BOOLEAN fgSetQuery,
			  BOOLEAN fgNeedResp, PFN_CMD_DONE_HANDLER pfCmdDoneHandler,
...
VOID bowIndicationOfMediaStateToHost(IN P_ADAPTER_T prAdapter, ENUM_PARAM_MEDIA_STATE_T eConnectionState,
