...
typedef VOID (*KAL_P2P_UPDATE_ASSOC_INFO)(IN P_GLUE_INFO_T prGlueInfo, IN PUINT_8 pucFrameBody,
					  IN UINT_32 u4FrameBodyLen, IN BOOLEAN fgReassocRequest);

typedef BOOLEAN (*P2P_VALIDATE_AUTH)(IN P_ADAPTER_T prAdapter, IN P_SW_RFB_T prSwRfb, IN PP_STA_RECORD_T pprStaRec,
				     OUT PUINT_16 pu2StatusCode);

typedef BOOLEAN (*P2P_VALIDATE_ASSOC_REQ)(IN P_ADAPTER_T prAdapter, IN P_SW_RFB_T prSwRfb,
					  OUT PUINT_16 pu4ControlFlags);

typedef VOID (*P2P_RUN_EVENT_AAA_TX_FAIL)(IN P_ADAPTER_T prAdapter, IN P_STA_RECORD_T prStaRec);

typedef BOOLEAN (*P2P_PARSE_CHECK_FOR_P2P_INFO_ELEM)(IN P_ADAPTER_T prAdapter, IN PUINT_8 pucBuf,
						     OUT PUINT_8 pucOuiType);

typedef WLAN_STATUS (*P2P_RUN_EVENT_AAA_COMPLETE)(IN P_ADAPTER_T prAdapter, IN P_STA_RECORD_T prStaRec);

typedef VOID (*P2P_PROCESS_EVENT_UPDATE_NOA_PARAM)(IN P_ADAPTER_T prAdapter, UINT_8 ucNetTypeIndex,
						   P_EVENT_UPDATE_NOA_PARAMS_T prEventUpdateNoaParam);

typedef VOID (*SCAN_P2P_PROCESS_BEACON_AND_PROBE_RESP)(IN P_ADAPTER_T prAdapter, IN P_SW_RFB_T prSwRfb,
...
typedef BOOLEAN (*P2P_FUNC_VALIDATE_PROBE_REQ)(IN P_ADAPTER_T prAdapter, IN P_SW_RFB_T prSwRfb,
...
typedef PUINT_8 (*P2P_BUILD_REASSOC_REQ_FRAME_COMMON_IES)(IN P_ADAPTER_T prAdapter, IN P_MSDU_INFO_T prMsduInfo,
							  IN PUINT_8 pucBuffer);

typedef VOID (*P2P_FUNC_DISCONNECT)(IN P_ADAPTER_T prAdapter, IN P_STA_RECORD_T prStaRec, IN BOOLEAN fgSendDeauth,
				    IN UINT_16 u2ReasonCode);

typedef VOID (*P2P_FSM_RUN_EVENT_RX_DEAUTH)(IN P_ADAPTER_T prAdapter, IN P_STA_RECORD_T prStaRec,
					    IN P_SW_RFB_T prSwRfb);

typedef VOID (*P2P_FSM_RUN_EVENT_RX_DISASSOC)(IN P_ADAPTER_T prAdapter, IN P_STA_RECORD_T prStaRec,
					      IN P_SW_RFB_T prSwRfb);
