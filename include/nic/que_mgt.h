...
typedef UINT_32 (*PFN_DEQUEUE_FUNCTION)(IN P_ADAPTER_T prAdapter, OUT P_QUE_T prQue, IN UINT_8 ucTC,
...
#define QM_TX_GET_NEXT_MSDU_INFO(_prMsduInfo) ((P_MSDU_INFO_T)(((_prMsduInfo)->rQueEntry).prNext))
...
UINT_32 gmGetDequeueQuota(IN P_ADAPTER_T prAdapter, IN P_STA_RECORD_T prStaRec, IN P_BSS_INFO_T prBssInfo,
...
UINT_32
mqmGenerateWmmInfoIEByStaRec(P_ADAPTER_T prAdapter, P_BSS_INFO_T prBssInfo, P_STA_RECORD_T prStaRec,
			     P_UINT_8 pucOutBuf);
