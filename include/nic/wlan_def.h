...
#define PHY_TYPE_SET_802_11ABGN (PHY_TYPE_BIT_OFDM | PHY_TYPE_BIT_HR_DSSS | PHY_TYPE_BIT_ERP | PHY_TYPE_BIT_HT)

#define PHY_TYPE_SET_802_11BGN (PHY_TYPE_BIT_HR_DSSS | PHY_TYPE_BIT_ERP | PHY_TYPE_BIT_HT)

#define PHY_TYPE_SET_802_11GN (PHY_TYPE_BIT_ERP | PHY_TYPE_BIT_HT)

#define PHY_TYPE_SET_802_11AN (PHY_TYPE_BIT_OFDM | PHY_TYPE_BIT_HT)

#define PHY_TYPE_SET_802_11ABG (PHY_TYPE_BIT_OFDM | PHY_TYPE_BIT_HR_DSSS | PHY_TYPE_BIT_ERP)
...
#define PHY_TYPE_SET_802_11ANAC (PHY_TYPE_BIT_OFDM | PHY_TYPE_BIT_HT | PHY_TYPE_BIT_VHT)

#define PHY_TYPE_SET_802_11ABGNAC \
	(PHY_TYPE_BIT_OFDM | PHY_TYPE_BIT_HR_DSSS | PHY_TYPE_BIT_ERP | PHY_TYPE_BIT_HT | PHY_TYPE_BIT_VHT)
...
#define RATE_SET_HR_DSSS (RATE_SET_BIT_1M | RATE_SET_BIT_2M | RATE_SET_BIT_5_5M | RATE_SET_BIT_11M)

#define RATE_SET_ERP \
	(RATE_SET_BIT_1M | RATE_SET_BIT_2M | RATE_SET_BIT_5_5M | RATE_SET_BIT_11M | RATE_SET_BIT_6M | \
	 RATE_SET_BIT_9M | RATE_SET_BIT_12M | RATE_SET_BIT_18M | RATE_SET_BIT_24M | RATE_SET_BIT_36M | \
	 RATE_SET_BIT_48M | RATE_SET_BIT_54M)

#define RATE_SET_ERP_P2P \
	(RATE_SET_BIT_6M | RATE_SET_BIT_9M | RATE_SET_BIT_12M | RATE_SET_BIT_18M | RATE_SET_BIT_24M | \
	 RATE_SET_BIT_36M | RATE_SET_BIT_48M | RATE_SET_BIT_54M)

#define RATE_SET_OFDM \
	(RATE_SET_BIT_6M | RATE_SET_BIT_9M | RATE_SET_BIT_12M | RATE_SET_BIT_18M | RATE_SET_BIT_24M | \
	 RATE_SET_BIT_36M | RATE_SET_BIT_48M | RATE_SET_BIT_54M)
...
#define BASIC_RATE_SET_HR_DSSS (RATE_SET_BIT_1M | RATE_SET_BIT_2M)

#define BASIC_RATE_SET_HR_DSSS_ERP (RATE_SET_BIT_1M | RATE_SET_BIT_2M | RATE_SET_BIT_5_5M | RATE_SET_BIT_11M)

#define BASIC_RATE_SET_ERP \
	(RATE_SET_BIT_1M | RATE_SET_BIT_2M | RATE_SET_BIT_5_5M | RATE_SET_BIT_11M | RATE_SET_BIT_6M | \
	 RATE_SET_BIT_12M | RATE_SET_BIT_24M)

#define BASIC_RATE_SET_OFDM (RATE_SET_BIT_6M | RATE_SET_BIT_12M | RATE_SET_BIT_24M)

#define BASIC_RATE_SET_ERP_P2P (RATE_SET_BIT_6M | RATE_SET_BIT_12M | RATE_SET_BIT_24M)

#define INITIAL_RATE_SET_RCPI_100 RATE_SET_ALL_ABG

#define INITIAL_RATE_SET_RCPI_80 \
	(RATE_SET_BIT_1M | RATE_SET_BIT_2M | RATE_SET_BIT_5_5M | RATE_SET_BIT_11M | RATE_SET_BIT_6M | \
	 RATE_SET_BIT_9M | RATE_SET_BIT_12M | RATE_SET_BIT_24M)

#define INITIAL_RATE_SET_RCPI_60 \
	(RATE_SET_BIT_1M | RATE_SET_BIT_2M | RATE_SET_BIT_5_5M | RATE_SET_BIT_11M | RATE_SET_BIT_6M)
...
typedef enum _ENUM_HW_BSSID_T { BSSID_0 = 0, BSSID_1, BSSID_2, BSSID_3, BSSID_NUM } ENUM_HW_BSSID_T;

typedef enum _ENUM_HW_MAC_ADDR_T { MAC_ADDR_0 = 0, MAC_ADDR_1, MAC_ADDR_NUM } ENUM_HW_MAC_ADDR_T;
...
typedef enum _ENUM_AC_T { AC0 = 0, AC1, AC2, AC3, AC_NUM } ENUM_AC_T, *P_ENUM_AC_T;
...
typedef enum _ENUM_PWR_STATE_T { PWR_STATE_IDLE = 0, PWR_STATE_ACTIVE, PWR_STATE_PS, PWR_STATE_NUM } ENUM_PWR_STATE_T;
...
typedef enum _ENUM_SW_RATE_INDEX_T {
	...
	RATE_NUM_SW	      /* 15 */
} ENUM_SW_RATE_INDEX_T,
	*P_ENUM_SW_RATE_INDEX_T;
...
typedef enum _ENUM_CCK_RATE_INDEX_T {
	...
	RATE_11M_INDEX,	   /* 11M */
	CCK_RATE_NUM	   /* 4 */
} ENUM_CCK_RATE_INDEX_T,
	*P_ENUM_CCK_RATE_INDEX_T;
...
typedef enum _ENUM_OFDM_RATE_INDEX_T {
	...
	RATE_54M_INDEX,	   /* 54M */
	OFDM_RATE_NUM	   /* 8 */
} ENUM_OFDM_RATE_INDEX_T,
	*P_ENUM_OFDM_RATE_INDEX_T;
...
typedef enum _ENUM_HT_RATE_INDEX_T {
	...
	HT_RATE_MCS15_INDEX,
	HT_RATE_NUM /* 16 */
} ENUM_HT_RATE_INDEX_T,
	*P_ENUM_HT_RATE_INDEX_T;
...
typedef enum _ENUM_VHT_RATE_INDEX_T {
	...
	VHT_RATE_MCS9_INDEX,
	VHT_RATE_NUM /* 10 */
} ENUM_VHT_RATE_INDEX_T,
	*P_ENUM_VHT_RATE_INDEX_T;
...
typedef enum _ENUM_PREMABLE_OPTION_T {
	...
	PREAMBLE_VHT_FIELD,
	PREAMBLE_OPTION_NUM
} ENUM_PREMABLE_OPTION_T,
	*P_ENUM_PREMABLE_OPTION_T;
...
} ENUM_MODULATION_SYSTEM_T,
	*P_ENUM_MODULATION_SYSTEM_T;
...
typedef enum _ENUM_MODULATION_TYPE_T {
	...
	MODULATION_TYPE_NUM
} ENUM_MODULATION_TYPE_T,
	*P_ENUM_MODULATION_TYPE_T;
...
typedef enum _ENUM_CHANNEL_WIDTH_T {
	...
	*P_ENUM_CHANNEL_WIDTH_P;

/* This starting freq of the band is unit of kHz */
typedef enum _ENUM_BAND_T { BAND_NULL, BAND_2G4, BAND_5G, BAND_NUM } ENUM_BAND_T, *P_ENUM_BAND_T;
...
} ENUM_PS_FORWARDING_TYPE_T,
	*P_ENUM_PS_FORWARDING_TYPE_T;
...
typedef enum _ENUM_MAC_BANDWIDTH_T {
	...
	MAC_BW_80,
	MAC_BW_160
} ENUM_MAC_BANDWIDTH_T,
	*P_ENUM_MAC_BANDWIDTH_T;
...
} ENUM_PARAM_CONNECTION_POLICY_T,
	*P_ENUM_PARAM_CONNECTION_POLICY_T;
...
} ENUM_PARAM_PREAMBLE_TYPE_T,
	*P_ENUM_PARAM_PREAMBLE_TYPE_T;
...
typedef enum _ENUM_PARAM_PHY_CONFIG_T {
	...
	PHY_CONFIG_NUM /* 12 */
} ENUM_PARAM_PHY_CONFIG_T,
	*P_ENUM_PARAM_PHY_CONFIG_T;
...
typedef enum _ENUM_PARAM_AP_MODE_T {
	...
	AP_MODE_NUM	    /* 4 */
} ENUM_PARAM_AP_MODE_T,
	*P_ENUM_PARAM_AP_MODE_T;
...
#if CFG_SUPPORT_CSI
enum ENUM_CSI_MODULATION_BW_TYPE_T { CSI_TYPE_CCK_BW20, CSI_TYPE_OFDM_BW20, CSI_TYPE_OFDM_BW40, CSI_TYPE_OFDM_BW80 };
#endif
...
#define WLAN_GET_FIELD_32(_memAddr_p, _value_p) \
	{ \
		PUINT_8 __cp = (PUINT_8)(_memAddr_p); \
		*(PUINT_32)(_value_p) = ((UINT_32)__cp[0]) | ((UINT_32)__cp[1] << 8) | ((UINT_32)__cp[2] << 16) | \
					((UINT_32)__cp[3] << 24); \
	}
...
#define WLAN_GET_FIELD_64(_memAddr_p, _value_p) \
	{ \
		PUINT_8 __cp = (PUINT_8)(_memAddr_p); \
		*(PUINT_64)(_value_p) = ((UINT_64)__cp[0]) | ((UINT_64)__cp[1] << 8) | ((UINT_64)__cp[2] << 16) | \
					((UINT_64)__cp[3] << 24) | ((UINT_64)__cp[4] << 32) | \
					((UINT_64)__cp[5] << 40) | ((UINT_64)__cp[6] << 48) | \
					((UINT_64)__cp[7] << 56); \
	}
