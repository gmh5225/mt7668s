...
#define NIC_TX_INIT_BUFF_SUM \
	(NIC_TX_INIT_BUFF_COUNT_TC0 + NIC_TX_INIT_BUFF_COUNT_TC1 + NIC_TX_INIT_BUFF_COUNT_TC2 + \
	 NIC_TX_INIT_BUFF_COUNT_TC3 + NIC_TX_INIT_BUFF_COUNT_TC4 + NIC_TX_INIT_BUFF_COUNT_TC5)
...
#define NIC_TX_MAX_PAGE_PER_FRAME \
	((NIC_TX_DESC_AND_PADDING_LENGTH + NIC_TX_DESC_HEADER_PADDING_LENGTH + NIC_TX_MAX_SIZE_PER_FRAME + \
	  NIC_TX_PAGE_SIZE - 1) / \
	 NIC_TX_PAGE_SIZE)
...
#define NIC_TX_HEAD_ROOM (NIC_TX_DESC_LONG_FORMAT_LENGTH + NIC_TX_DESC_PADDING_LENGTH + HW_MAC_TX_DESC_APPEND_T_LENGTH)
...
typedef enum _ENUM_MSDU_CONTROL_FLAG_T { MSDU_CONTROL_FLAG_FORCE_TX = BIT(0) } ENUM_MSDU_CONTROL_FLAG_T;
...
typedef WLAN_STATUS (*PFN_TX_DONE_HANDLER)(IN P_ADAPTER_T prAdapter, IN P_MSDU_INFO_T prMsduInfo,
...
#define TX_GET_CNT(prTxCtrl, eCounter) (((P_TX_CTRL_T)prTxCtrl)->au4Statistics[eCounter])
 ...
 *------------------------------------------------------------------------------
 */
#define TX_DESC_GET_FIELD(_rHwMacTxDescField, _mask, _offset) (((_rHwMacTxDescField) & (_mask)) >> (_offset))
...
#define HAL_MAC_TX_DESC_GET_ETHER_TYPE_OFFSET(_prHwMacTxDesc) \
	TX_DESC_GET_FIELD((_prHwMacTxDesc)->ucEtherOffset, TX_DESC_ETHER_TYPE_OFFSET_MASK, \
...
#define HAL_MAC_TX_DESC_SET_QUEUE_INDEX(_prHwMacTxDesc, _ucQueueIndex) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->ucPortIdx_QueueIdx), ((UINT_8)_ucQueueIndex), TX_DESC_QUEUE_INDEX_MASK, \
...
#define HAL_MAC_TX_DESC_SET_PORT_INDEX(_prHwMacTxDesc, _ucPortIndex) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->ucPortIdx_QueueIdx), ((UINT_8)_ucPortIndex), TX_DESC_PORT_INDEX, \
			  TX_DESC_PORT_INDEX_OFFSET)

/* DW 1 */
#define HAL_MAC_TX_DESC_GET_WLAN_INDEX(_prHwMacTxDesc) ((_prHwMacTxDesc)->ucWlanIdx)
#define HAL_MAC_TX_DESC_SET_WLAN_INDEX(_prHwMacTxDesc, _ucWlanIdx) (((_prHwMacTxDesc)->ucWlanIdx) = (_ucWlanIdx))
...
#define HAL_MAC_TX_DESC_SET_HEADER_FORMAT(_prHwMacTxDesc, _ucHdrFormat) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->ucHeaderFormat), ((UINT_8)_ucHdrFormat), TX_DESC_HEADER_FORMAT_MASK, \
...
#define HAL_MAC_TX_DESC_GET_802_11_HEADER_LENGTH(_prHwMacTxDesc) \
	TX_DESC_GET_FIELD((_prHwMacTxDesc)->ucHeaderFormat, TX_DESC_NOR_802_11_HEADER_LENGTH_MASK, \
...
#define HAL_MAC_TX_DESC_SET_TXD_LENGTH(_prHwMacTxDesc, _ucHdrPadding) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->ucHeaderPadding), ((UINT_8)_ucHdrPadding), TX_DESC_TXD_LENGTH_MASK, \
			  TX_DESC_TXD_LENGTH_OFFSET)

#define HAL_MAC_TX_DESC_GET_TXD_EXTEND_LENGTH(_prHwMacTxDesc) \
	TX_DESC_GET_FIELD((_prHwMacTxDesc)->ucHeaderPadding, TX_DESC_TXD_EXTEND_LENGTH_MASK, \
...
#define HAL_MAC_TX_DESC_GET_HEADER_PADDING(_prHwMacTxDesc) \
	TX_DESC_GET_FIELD((_prHwMacTxDesc)->ucHeaderPadding, TX_DESC_HEADER_PADDING_LENGTH_MASK, \
...
#define HAL_MAC_TX_DESC_SET_UTXB_AMSDU(_prHwMacTxDesc, _ucHdrPadding) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->ucHeaderPadding), ((UINT_8)_ucHdrPadding), TX_DESC_TXD_UTXB_AMSDU_MASK, \
...
#define HAL_MAC_TX_DESC_SET_PKT_FORMAT(_prHwMacTxDesc, _ucPktFormat) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->ucOwnMAC), ((UINT_8)_ucPktFormat), TX_DESC_PACKET_FORMAT_MASK, \
...
#define HAL_MAC_TX_DESC_SET_OWN_MAC_INDEX(_prHwMacTxDesc, _ucOwnMacIdx) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->ucOwnMAC), ((UINT_8)_ucOwnMacIdx), TX_DESC_OWN_MAC_MASK, \
...
#define HAL_MAC_TX_DESC_SET_SUB_TYPE(_prHwMacTxDesc, _ucSubType) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->ucType_SubType), ((UINT_8)_ucSubType), TX_DESC_SUB_TYPE_MASK, \
...
#define HAL_MAC_TX_DESC_SET_FRAG_PACKET_POS(_prHwMacTxDesc, _ucFragPos) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->ucFrag), ((UINT_8)_ucFragPos), TX_DESC_FRAGMENT_MASK, \
...
#define HAL_MAC_TX_DESC_SET_SW_RESERVED(_prHwMacTxDesc, _ucSwReserved) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->u2TxCountLimit), ((UINT_8)_ucSwReserved), TX_DESC_SW_RESERVED_MASK, \
...
#define HAL_MAC_TX_DESC_SET_TX_COUNT(_prHwMacTxDesc, _ucTxCountLimit) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->u2TxCountLimit), ((UINT_8)_ucTxCountLimit), TX_DESC_TX_COUNT_MASK, \
			  TX_DESC_TX_COUNT_OFFSET)
#define HAL_MAC_TX_DESC_GET_REMAINING_TX_COUNT(_prHwMacTxDesc) \
	TX_DESC_GET_FIELD((_prHwMacTxDesc)->u2TxCountLimit, TX_DESC_REMAINING_TX_COUNT_MASK, \
...
#define HAL_MAC_TX_DESC_SET_HW_RESERVED(_prHwMacTxDesc, _ucHwReserved) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->u2SN), ((UINT_8)_ucHwReserved), TX_DESC_HW_RESERVED_MASK, \
...
#define HAL_MAC_TX_DESC_SET_PID(_prHwMacTxDesc, _ucPID) (((_prHwMacTxDesc)->ucPID) = (_ucPID))
...
#define HAL_MAC_TX_DESC_SET_TXS_FORMAT(_prHwMacTxDesc, _ucTXSFormat) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->ucTxStatus), ((UINT_8)_ucTXSFormat), TX_DESC_TX_STATUS_FORMAT, \
...
#define HAL_MAC_TX_DESC_SET_FR_DYNAMIC_BW_RTS(_prHwMacTxDesc) ((_prHwMacTxDesc)->u2AntID |= TX_DESC_DYNAMIC_BANDWIDTH)

#define HAL_MAC_TX_DESC_SET_FR_ANTENNA_ID(_prHwMacTxDesc, _ucAntId) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->u2AntID), ((UINT_8)_ucAntId), TX_DESC_ANTENNA_INDEX_MASK, \
			  TX_DESC_ANTENNA_INDEX_OFFSET)

#define HAL_MAC_TX_DESC_SET_FR_RATE(_prHwMacTxDesc, _u2RatetoFixed) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->u2FixedRate), ((UINT_8)_u2RatetoFixed), TX_DESC_FIXDE_RATE_MASK, \
			  TX_DESC_FIXDE_RATE_OFFSET)

#define HAL_MAC_TX_DESC_SET_FR_BF(_prHwMacTxDesc) ((_prHwMacTxDesc)->u2FixedRate |= TX_DESC_BF)

#define HAL_MAC_TX_DESC_SET_FR_LDPC(_prHwMacTxDesc) ((_prHwMacTxDesc)->u2FixedRate |= TX_DESC_LDPC)

#define HAL_MAC_TX_DESC_SET_FR_SHORT_GI(_prHwMacTxDesc) ((_prHwMacTxDesc)->u2FixedRate |= TX_DESC_GUARD_INTERVAL)

#define HAL_MAC_TX_DESC_SET_FR_NORMAL_GI(_prHwMacTxDesc) ((_prHwMacTxDesc)->u2FixedRate &= ~TX_DESC_GUARD_INTERVAL)
...
#define HAL_MAC_TX_DESC_SET_SPE_IDX(_prHwMacTxDesc, _ucSpeIdx) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->u2SwTxTime), ((UINT_16)_ucSpeIdx), TX_DESC_SPE_EXT_IDX_MASK, \
...
VOID nicTxSetMngPacket(IN P_ADAPTER_T prAdapter, IN P_MSDU_INFO_T prMsduInfo, IN UINT_8 ucBssIndex,
		       IN UINT_8 ucStaRecIndex, IN UINT_8 ucMacHeaderLength, IN UINT_16 u2FrameLength,
		       IN PFN_TX_DONE_HANDLER pfTxDoneHandler, IN UINT_8 ucRateMode);

VOID nicTxSetDataPacket(IN P_ADAPTER_T prAdapter, IN P_MSDU_INFO_T prMsduInfo, IN UINT_8 ucBssIndex,
			IN UINT_8 ucStaRecIndex, IN UINT_8 ucMacHeaderLength, IN UINT_16 u2FrameLength,
			IN PFN_TX_DONE_HANDLER pfTxDoneHandler, IN UINT_8 ucRateMode, IN ENUM_TX_PACKET_SRC_T eSrc,
...
VOID nicTxSetPktFixedRateOption(IN P_MSDU_INFO_T prMsduInfo, IN UINT_16 u2RateCode, IN UINT_8 ucBandwidth,
				IN BOOLEAN fgShortGI, IN BOOLEAN fgDynamicBwRts);
...
VOID nicTxPrintMetRTP(IN P_ADAPTER_T prAdapter, IN P_MSDU_INFO_T prMsduInfo, IN P_NATIVE_PACKET prPacket,
		      IN UINT_32 u4PacketLen, IN BOOLEAN bFreeSkb);
