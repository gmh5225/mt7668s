...
#define RX_STATUS_FLAG_ERROR_MASK \
	(RX_STATUS_FLAG_FCS_ERROR | RX_STATUS_FLAG_ICV_ERROR | RX_STATUS_FLAG_CIPHER_LENGTH_MISMATCH) /* No TKIP MIC \
													 error */
...
typedef enum _ENUM_MAC_GI_INFO_T { MAC_GI_NORMAL = 0, MAC_GI_SHORT } ENUM_MAC_GI_INFO_T, *P_ENUM_MAC_GI_INFO_T;
...
#define RATE_INFO(_RateCode, _Bw20, _Bw20SGI, _Bw40, _BW40SGI, _Bw80, _Bw80SGI, _Bw160, _Bw160SGI) \
	{ \
		.ucPhyRateCode = (_RateCode), .u4PhyRate[RX_VT_FR_MODE_20][MAC_GI_NORMAL] = (_Bw20), \
...
#define RX_GET_CNT(prRxCtrl, eCounter) (((P_RX_CTRL_T)prRxCtrl)->au8Statistics[eCounter])
...
#define RX_STATUS_TEST_MORE_FLAG(flag) ((BOOL)((flag & RX_STATUS_FLAG_MORE_PACKET) ? TRUE : FALSE))
...
#define HAL_RX_STATUS_GET_RF_BAND(_prHwMacRxDesc) \
	((((_prHwMacRxDesc)->ucChanFreq) <= HW_CHNL_NUM_MAX_2G4) ? BAND_2G4 : BAND_5G)
...
#define RXM_IS_QOS_DATA_FRAME(_u2FrameCtrl) (((_u2FrameCtrl & MASK_FRAME_TYPE) == MAC_FRAME_QOS_DATA) ? TRUE : FALSE)
