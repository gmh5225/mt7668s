...
#define CFG_SUPPORT_CFG80211_QUEUE 1
#define _HIF_SDIO 1
...
//#define CFG_DRIVER_INF_NAME_CHANGE=n
...
#define CFG_RX_MAX_PKT_NUM ((CFG_NUM_OF_RX0_HIF_DESC + CFG_NUM_OF_RX1_HIF_DESC) * 3 + CFG_NUM_OF_QM_RX_PKT_NUM)
 ...
 *------------------------------------------------------------------------------
 */
#define CFG_SUPPORT_LOW_POWER_DEBUG 0
