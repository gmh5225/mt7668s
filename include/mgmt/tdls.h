...
#define TDLSEX_STA_REC_IDX_GET(__prAdapter__, __MsduInfo__) \
	{ \
		...
		__StaRec__ = cnmGetStaRecByAddress(__prAdapter__, (UINT_8)NETWORK_TYPE_AIS_INDEX, \
...
typedef enum _TDLS_CMD_CORE_ID { TDLS_CORE_CMD_TEST_NULL_RCV = 0x00 } TDLS_CMD_CORE_ID;
...
typedef enum _TDLS_EVENT_HOST_ID { TDLS_HOST_EVENT_TEAR_DOWN = 0x00, TDLS_HOST_EVENT_TX_DONE } TDLS_EVENT_HOST_ID;
