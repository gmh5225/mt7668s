...
/*----------------------------------------------------------------------------*/
P_STA_RECORD_T
bssCreateStaRecFromBssDesc(IN P_ADAPTER_T prAdapter, IN ENUM_STA_TYPE_T eStaType, IN UINT_8 uBssIndex,
			   IN P_BSS_DESC_T prBssDesc);

#if CFG_SUPPORT_CFG80211_AUTH
P_STA_RECORD_T
bssUpdateStaRecFromCfgAssoc(IN P_ADAPTER_T prAdapter, IN P_BSS_DESC_T prBssDesc, IN P_STA_RECORD_T prStaRec);
#endif
...
WLAN_STATUS
bssSendBeaconProbeResponse(IN P_ADAPTER_T prAdapter, IN UINT_8 uBssIndex, IN PUINT_8 pucDestAddr,
...
typedef enum _ENUM_ACI_T { ACI_BE = 0, ACI_BK = 1, ACI_VI = 2, ACI_VO = 3, ACI_NUM } ENUM_ACI_T, *P_ENUM_ACI_T;
