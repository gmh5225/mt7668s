...
typedef enum _ENUM_SCAN_STATE_T { SCAN_STATE_IDLE = 0, SCAN_STATE_SCANNING, SCAN_STATE_NUM } ENUM_SCAN_STATE_T;
...
P_BSS_DESC_T
scanSearchBssDescByBssidAndChanNum(IN P_ADAPTER_T prAdapter, IN UINT_8 aucBSSID[], IN BOOLEAN fgCheckChanNum,
...
VOID scanBuildProbeReqFrameCommonIEs(IN P_MSDU_INFO_T prMsduInfo, IN PUINT_8 pucDesiredSsid,
