...
enum ENUM_COEX_CTRL_CMD { ENUM_COEX_CTRL_ISO_DETECT = 1, ENUM_COEX_CTRL_GET_INFO = 2, ENUM_COEX_CTRL_NUM };
...
#if (CFG_SUPPORT_DFS_MASTER == 1)
typedef enum _ENUM_REG_DOMAIN_T { REG_DEFAULT = 0, REG_JP_53, REG_JP_56 } ENUM_REG_DOMAIN_T, *P_ENUM_REG_DOMAIN_T;
...
enum CSI_CONTROL_MODE_T { CSI_CONTROL_MODE_STOP, CSI_CONTROL_MODE_START, CSI_CONTROL_MODE_SET, CSI_CONTROL_MODE_NUM };
