...
#define CMD_FORMAT_V1_LENGTH \
	(MAX_CMD_NAME_MAX_LENGTH + MAX_CMD_VALUE_MAX_LENGTH + MAX_CMD_TYPE_LENGTH + MAX_CMD_STRING_LENGTH + \
	 MAX_CMD_VALUE_LENGTH + MAX_CMD_RESERVE_LENGTH)
 ...
 *                             D A T A   T Y P E S
 *******************************************************************************/
typedef WLAN_STATUS (*PFN_OID_HANDLER_FUNC)(IN P_ADAPTER_T prAdapter, IN PVOID pvBuf, IN UINT_32 u4BufLen,
...
enum { DEBUG_MSG_ID_UNKNOWN = 0x00, DEBUG_MSG_ID_PRINT = 0x01, DEBUG_MSG_ID_FWLOG = 0x02, DEBUG_MSG_ID_END };
...
#define BUILD_SIGN(ch0, ch1, ch2, ch3) \
	((UINT_32)(UINT_8)(ch0) | ((UINT_32)(UINT_8)(ch1) << 8) | ((UINT_32)(UINT_8)(ch2) << 16) | \
	 ((UINT_32)(UINT_8)(ch3) << 24))

#define MTK_WIFI_SIGNATURE BUILD_SIGN('M', 'T', 'K', 'W')

#define IS_FEATURE_ENABLED(_ucFeature) (((_ucFeature) == FEATURE_ENABLED) || ((_ucFeature) == FEATURE_FORCE_ENABLED))
...
WLAN_STATUS
wlanQueryInformation(IN P_ADAPTER_T prAdapter, IN PFN_OID_HANDLER_FUNC pfOidQryHandler, IN PVOID pvInfoBuf,
		     IN UINT_32 u4InfoBufLen, OUT PUINT_32 pu4QryInfoLen);

WLAN_STATUS
wlanSetInformation(IN P_ADAPTER_T prAdapter, IN PFN_OID_HANDLER_FUNC pfOidSetHandler, IN PVOID pvInfoBuf,
...
WLAN_STATUS wlanImageSectionDownloadStage(IN P_ADAPTER_T prAdapter, IN PVOID pvFwImageMapFile,
					  IN UINT_32 u4FwImageFileLength, UINT_8 ucSectionNumber,
					  IN ENUM_IMG_DL_IDX_T eDlIdx, OUT PUINT_8 ucIsCompressed,
...
WLAN_STATUS wlanDhcpTxDone(IN P_ADAPTER_T prAdapter, IN P_MSDU_INFO_T prMsduInfo,
