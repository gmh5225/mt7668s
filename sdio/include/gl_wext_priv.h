...
typedef WLAN_STATUS (*PFN_OID_HANDLER_FUNC_REQ)(IN PVOID prAdapter, IN OUT PVOID pvBuf, IN UINT_32 u4BufLen,
...
int priv_support_mdns_offload(IN struct net_device *prDev, IN OUT struct ifreq *prReq, IN int i4Cmd);
#endif
...
int alps_android_private_support_driver_cmd(IN struct net_device *prDev, IN OUT struct ifreq *prReq, IN int i4Cmd);
