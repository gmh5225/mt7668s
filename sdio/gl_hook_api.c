...
INT_32 MT_ATEStart(struct net_device *prNetDev, UINT_8 *prInBuf)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SetATE = %s\n", prInBuf);
...
INT_32 MT_ATESetChannel(struct net_device *prNetDev, UINT_32 u4SXIdx, UINT_32 u4SetFreq)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SetChannel=%d, Freq=%d\n", i4SetChan, u4SetFreq);
...
INT_32 MT_ATESetPreamble(struct net_device *prNetDev, UINT_32 u4Mode)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SetPreamble=%d\n", u4Mode);
...
INT_32 MT_ATESetSystemBW(struct net_device *prNetDev, UINT_32 u4BW)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SetSystemBW=%d\n", u4BW);
...
INT_32 MT_ATESetTxLength(struct net_device *prNetDev, UINT_32 u4TxLength)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SetTxLength=%d\n", u4TxLength);
...
INT_32 MT_ATESetTxCount(struct net_device *prNetDev, UINT_32 u4TxCount)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SetTxCount=%d\n", u4TxCount);
...
INT_32 MT_ATESetTxIPG(struct net_device *prNetDev, UINT_32 u4TxIPG)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SetTxIPG=%d\n", u4TxIPG);
...
INT_32 MT_ATESetTxPower0(struct net_device *prNetDev, UINT_32 u4TxPower0)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SetTxPower0=0x%02x\n", u4TxPower0);

	if (u4TxPower0 > 0x3F) {
		u4TxPower0 += 128;
		DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK Negative Power =0x%02x\n", u4TxPower0);
	}
...
INT_32 MT_ATESetPerPacketBW(struct net_device *prNetDev, UINT_32 u4BW)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SetPerPacketBW=%d\n", u4BW);
...
INT_32 MT_ATEPrimarySetting(struct net_device *prNetDev, UINT_32 u4PrimaryCh)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK PrimarySetting=%d\n", u4PrimaryCh);
...
INT_32 MT_ATESetTxGi(struct net_device *prNetDev, UINT_32 u4SetTxGi)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SetTxGi=%d\n", u4SetTxGi);
...
INT_32 MT_ATESetTxPath(struct net_device *prNetDev, UINT_32 u4Tx_path)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK u4Tx_path=%d\n", u4Tx_path);
...
INT_32 MT_ATESetTxPayLoad(struct net_device *prNetDev, UINT_32 u4Gen_payload_rule, UINT_8 ucPayload)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK rule=%d, len =0x%x\n", u4Gen_payload_rule, ucPayload);
...
INT_32 MT_ATESetTxSTBC(struct net_device *prNetDev, UINT_32 u4Stbc)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK u4Stbc=%d\n", u4Stbc);
...
INT_32 MT_ATESetTxVhtNss(struct net_device *prNetDev, UINT_32 u4VhtNss)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK u4Nss=%d\n", u4VhtNss);
...
INT_32 MT_ATESetRate(struct net_device *prNetDev, UINT_32 u4Rate)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SetRate=0x%08x\n", u4Rate);
...
INT_32 MT_ATESetEncodeMode(struct net_device *prNetDev, UINT_32 u4Ldpc)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SetEncodeMode=%d\n", u4Ldpc);
...
INT_32 MT_ATESetiBFEnable(struct net_device *prNetDev, UINT_32 u4iBF)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SetiBFEnable=%d\n", u4iBF);
...
INT_32 MT_ATESeteBFEnable(struct net_device *prNetDev, UINT_32 u4eBF)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK SeteBFEnable=%d\n", u4eBF);
...
INT_32 MT_ATESetMACAddress(struct net_device *prNetDev, UINT_32 u4Type, PUINT_8 ucAddr)
{
	...
	DBGLOG(RFTEST, ERROR, "MT7668S : QA_ATE_HOOK SetMACAddress Type = %d, Addr = %02x:%02x:%02x:%02x:%02x:%02x\n",
...
INT_32 MT_ATELogOnOff(struct net_device *prNetDev, UINT_32 u4Type, UINT_32 u4On_off, UINT_32 u4Size)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATELogOnOff\n");

	switch (u4Type) {
	case ATE_LOG_RXV:
		DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATELogOnOff : ATE_LOG_RXV\n\n");
		break;
	case ATE_LOG_RDD:
		DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATELogOnOff : ATE_LOG_RDD\n\n");
		break;
	case ATE_LOG_RE_CAL:
		DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATELogOnOff : ATE_LOG_RE_CAL\n\n");
		break;
	case ATE_LOG_RXINFO:
		DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATELogOnOff : ATE_LOG_RXINFO\n\n");
		break;
	case ATE_LOG_TXDUMP:
		DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATELogOnOff : ATE_LOG_TXDUMP\n\n");
		break;
	case ATE_LOG_TEST:
		DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATELogOnOff : ATE_LOG_TEST\n\n");
		break;
	default:
		DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK log type %d not supported\n\n", u4Type);
	}
	...
	if ((u4On_off == ATE_LOG_DUMP) && (u4Type == ATE_LOG_RXV)) {
		...
		i4Status = kalIoctl(prGlueInfo, wlanoidRftestQueryAutoTest, &rRfATInfo, sizeof(rRfATInfo), TRUE, TRUE,
				    TRUE, &u4BufLen);

		if (i4Status == 0) {
			i4TargetLength = rRfATInfo.u4FuncData * 36;
			DBGLOG(RFTEST, ERROR, "MT7668S : QA_ATE_HOOK Get RX Vector Total size = %d\n", i4TargetLength);

			if (i4TargetLength >= (i4MaxDumpRXVCnt * 36))
				i4TargetLength = (i4MaxDumpRXVCnt * 36);
		} else {
			DBGLOG(RFTEST, ERROR, "MT7668S : QA_ATE_HOOK Get RX Vector Total Size Error!!!!\n\n");
		}
		...
		for (i = 0; i < i4TargetLength; i += 4) {
			...
			i4Status = kalIoctl(prGlueInfo, wlanoidRftestQueryAutoTest, &rRfATInfo, sizeof(rRfATInfo), TRUE,
					    TRUE, TRUE, &u4BufLen);
...
INT_32 MT_ATEResetTXRXCounter(struct net_device *prNetDev)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATEResetTXRXCounter\n");
...
INT_32 MT_ATESetDBDCBandIndex(struct net_device *prNetDev, UINT_32 u4BandIdx)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATESetDBDCBandIndex\n");
...
INT_32 MT_ATESetBand(struct net_device *prNetDev, INT_32 i4Band)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATESetBand\n");
...
INT_32 MT_ATESetTxToneType(struct net_device *prNetDev, INT_32 i4ToneType)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATESetTxToneType\n");
...
INT_32 MT_ATESetTxToneBW(struct net_device *prNetDev, INT_32 i4ToneFreq)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATESetTxToneBW\n");
...
INT_32 MT_ATESetTxToneDCOffset(struct net_device *prNetDev, INT_32 i4DcOffsetI, INT_32 i4DcOffsetQ)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATESetTxToneDCOffset\n");
...
INT_32 MT_ATESetDBDCTxTonePower(struct net_device *prNetDev, INT_32 i4AntIndex, INT_32 i4RF_Power, INT_32 i4Digi_Power)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATESetDBDCTxTonePower\n");
...
INT_32 MT_ATEDBDCTxTone(struct net_device *prNetDev, INT_32 i4Control)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATEDBDCTxTone\n");
...
INT_32 MT_ATESetMacHeader(struct net_device *prNetDev, UINT_32 u4FrameCtrl, UINT_32 u4DurationID, UINT_32 u4SeqCtrl)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATESetMacHeader\n");
			...
			UINT_32 u4Band, UINT_32 u4RunType, UINT_32 u4FType)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATE_IRRSetADC\n");
			   ...
			   UINT_32 u4WF_inx, UINT_32 u4Rfdgc)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATE_IRRSetRxGain\n");
			...
			UINT_32 u4Band)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATE_IRRSetTTG\n");
...
INT_32 MT_ATE_IRRSetTrunOnTTG(struct net_device *prNetDev, UINT_32 u4TTGOnOff, UINT_32 u4Band, UINT_32 u4WF_inx)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATE_IRRSetTrunOnTTG\n");
 ...
 */
/*----------------------------------------------------------------------------*/
INT_32 MT_ATE_TMRSetting(struct net_device *prNetDev, UINT_32 u4Setting, UINT_32 u4Version, UINT_32 u4MPThres,
			 UINT_32 u4MPIter)
{
	UINT_32 u4BufLen = 0;
	INT_32 i4Status;
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATE_TMRSetting\n");
...
INT_32 MT_ATEMPSSetSeqData(struct net_device *prNetDev, UINT_32 u4TestNum, UINT_32 *pu4Phy, UINT_32 u4Band)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATEMPSSetSeqData\n");
...
INT_32 MT_ATEMPSSetPayloadLength(struct net_device *prNetDev, UINT_32 u4TestNum, UINT_32 *pu4Length, UINT_32 u4Band)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATEMPSSetPayloadLength\n");
...
INT_32 MT_ATEMPSSetPacketCount(struct net_device *prNetDev, UINT_32 u4TestNum, UINT_32 *pu4PktCnt, UINT_32 u4Band)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATEMPSSetPacketCount\n");
...
INT_32 MT_ATEMPSSetPowerGain(struct net_device *prNetDev, UINT_32 u4TestNum, UINT_32 *pu4PwrGain, UINT_32 u4Band)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATEMPSSetPowerGain\n");
...
INT_32 MT_ATEMPSSetNss(struct net_device *prNetDev, UINT_32 u4TestNum, UINT_32 *pu4Nss, UINT_32 u4Band)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATEMPSSetNss\n");
...
INT_32 MT_ATEMPSSetPerpacketBW(struct net_device *prNetDev, UINT_32 u4TestNum, UINT_32 *pu4PerPktBW, UINT_32 u4Band)
{
	...
	DBGLOG(RFTEST, INFO, "MT7668S : QA_ATE_HOOK MT_ATEMPSSetPerpacketBW\n");
...
INT_32 MT_ATEWriteEfuse(struct net_device *prNetDev, UINT_16 u2Offset, UINT_16 u2Content)
{
	...
	i4Status = kalIoctl(prGlueInfo, wlanoidQueryProcessAccessEfuseRead, &rAccessEfuseInfoRead,
	...
	for (u4Loop = 0; u4Loop < (EFUSE_BLOCK_SIZE); u4Loop++) {
		DBGLOG(INIT, INFO, "MT7668S : QA_AGENT aucEepromVaule u4Loop=%d  u4Value=%x\n", u4Loop,
		       prGlueInfo->prAdapter->aucEepromVaule[u4Loop]);

		DBGLOG(INIT, INFO, "MT7668S : QA_AGENT rAccessEfuseInfoWrite.aucData u4Loop=%d  u4Value=%x\n", u4Loop,
		       rAccessEfuseInfoWrite.aucData[u4Loop]);
	}

	rAccessEfuseInfoWrite.u4Address = (u2Offset / EFUSE_BLOCK_SIZE) * EFUSE_BLOCK_SIZE;

	i4Status = kalIoctl(prGlueInfo, wlanoidQueryProcessAccessEfuseWrite, &rAccessEfuseInfoWrite,
...
INT_32 MT_ATESetTxTargetPower(struct net_device *prNetDev, UINT_8 ucTxTargetPower)
{
	...
	DBGLOG(INIT, INFO, "MT7668S : QA_AGENT Set Tx Target Power= %x dbm\n", ucTxTargetPower);
	rSetTxTargetPwr.ucTxTargetPwr = ucTxTargetPower;

	i4Status = kalIoctl(prGlueInfo, wlanoidQuerySetTxTargetPower, &rSetTxTargetPwr,
...
INT_32 MT_ATESetRddReport(struct net_device *prNetDev, UINT_8 ucDbdcIdx)
{
	...
	/* Set Rdd Report */
	DBGLOG(INIT, INFO, "MT7668S : QA_AGENT Set RDD Report - Band: %d\n", ucDbdcIdx);
	rSetRddReport.ucDbdcIdx = ucDbdcIdx;

	i4Status = kalIoctl(prGlueInfo, wlanoidQuerySetRddReport, &rSetRddReport, sizeof(PARAM_CUSTOM_SET_RDD_REPORT_T),
...
INT_32 MT_ATESetRadarDetectMode(struct net_device *prNetDev, UINT_8 ucRadarDetectMode)
{
	...
	/* Set Rdd Report */
	DBGLOG(INIT, INFO, "MT7668S : QA_AGENT Set Radar Detect Mode: %d\n", ucRadarDetectMode);
	rSetRadarDetectMode.ucRadarDetectMode = ucRadarDetectMode;

	i4Status = kalIoctl(prGlueInfo, wlanoidQuerySetRadarDetectMode, &rSetRadarDetectMode,
...
INT_32 TxBfProfileTag_McsThd(struct net_device *prNetDev, P_PFMU_PROFILE_TAG2 prPfmuTag2, PUINT_8 pMCSThLSS,
			     PUINT_8 pMCSThSSS)
{
	INT_32 i4Status = 0;
...
INT_32 TxBfProfileTagWrite(struct net_device *prNetDev, P_PFMU_PROFILE_TAG1 prPfmuTag1, P_PFMU_PROFILE_TAG2 prPfmuTag2,
			   UINT_8 profileIdx)
{
	INT_32 i4Status = 0;
	P_GLUE_INFO_T prGlueInfo = NULL;
	...
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : au4RawData[0] = 0x%08x\n", prPfmuTag1->au4RawData[0]);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : au4RawData[1] = 0x%08x\n", prPfmuTag1->au4RawData[1]);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : au4RawData[2] = 0x%08x\n", prPfmuTag1->au4RawData[2]);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : au4RawData[3] = 0x%08x\n", prPfmuTag1->au4RawData[3]);

	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : au4RawData[0] = 0x%08x\n", prPfmuTag2->au4RawData[0]);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : au4RawData[1] = 0x%08x\n", prPfmuTag2->au4RawData[1]);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : au4RawData[2] = 0x%08x\n", prPfmuTag2->au4RawData[2]);

	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucProfileID= %d\n",
	       prPfmuTag1->rField.ucProfileID);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucTxBf= %d\n", prPfmuTag1->rField.ucTxBf);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucDBW= %d\n", prPfmuTag1->rField.ucDBW);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucSU_MU= %d\n", prPfmuTag1->rField.ucSU_MU);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucInvalidProf= %d\n",
	       prPfmuTag1->rField.ucInvalidProf);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucRMSD= %d\n", prPfmuTag1->rField.ucRMSD);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucMemAddr1ColIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr1ColIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucMemAddr1RowIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr1RowIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucMemAddr2ColIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr2ColIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucMemAddr2RowIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr2RowIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucMemAddr2RowIdxMsb= %d\n",
	       prPfmuTag1->rField.ucMemAddr2RowIdxMsb);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucMemAddr3ColIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr3ColIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucMemAddr3RowIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr3RowIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucMemAddr4ColIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr4ColIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucMemAddr4RowIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr4RowIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucReserved= %d\n",
	       prPfmuTag1->rField.ucReserved);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucNrow= %d\n", prPfmuTag1->rField.ucNrow);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucNcol= %d\n", prPfmuTag1->rField.ucNcol);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucNgroup= %d\n", prPfmuTag1->rField.ucNgroup);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucLM= %d\n", prPfmuTag1->rField.ucLM);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucCodeBook= %d\n",
	       prPfmuTag1->rField.ucCodeBook);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucHtcExist= %d\n",
	       prPfmuTag1->rField.ucHtcExist);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucReserved1= %d\n",
	       prPfmuTag1->rField.ucReserved1);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucSNR_STS0= %d\n",
	       prPfmuTag1->rField.ucSNR_STS0);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucSNR_STS1= %d\n",
	       prPfmuTag1->rField.ucSNR_STS1);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucSNR_STS2= %d\n",
	       prPfmuTag1->rField.ucSNR_STS2);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucSNR_STS3= %d\n",
	       prPfmuTag1->rField.ucSNR_STS3);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag1 : prPfmuTag1->rField.ucIBfLnaIdx= %d\n",
	       prPfmuTag1->rField.ucIBfLnaIdx);

	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.u2SmartAnt = %d\n",
	       prPfmuTag2->rField.u2SmartAnt);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.ucReserved0 = %d\n",
	       prPfmuTag2->rField.ucReserved0);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.ucSEIdx = %d\n", prPfmuTag2->rField.ucSEIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.ucRMSDThd = %d\n", prPfmuTag2->rField.ucRMSDThd);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.ucReserved1 = %d\n",
	       prPfmuTag2->rField.ucReserved1);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.ucMCSThL1SS = %d\n",
	       prPfmuTag2->rField.ucMCSThL1SS);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.ucMCSThS1SS = %d\n",
	       prPfmuTag2->rField.ucMCSThS1SS);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.ucMCSThL2SS = %d\n",
	       prPfmuTag2->rField.ucMCSThL2SS);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.ucMCSThS2SS = %d\n",
	       prPfmuTag2->rField.ucMCSThS2SS);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.ucMCSThL3SS = %d\n",
	       prPfmuTag2->rField.ucMCSThL3SS);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.ucMCSThS3SS = %d\n",
	       prPfmuTag2->rField.ucMCSThS3SS);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.uciBfTimeOut = %d\n",
	       prPfmuTag2->rField.uciBfTimeOut);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.ucReserved2 = %d\n",
	       prPfmuTag2->rField.ucReserved2);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.ucReserved3 = %d\n",
	       prPfmuTag2->rField.ucReserved3);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.ucReserved4 = %d\n",
	       prPfmuTag2->rField.ucReserved4);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.uciBfDBW = %d\n", prPfmuTag2->rField.uciBfDBW);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.uciBfNcol = %d\n", prPfmuTag2->rField.uciBfNcol);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.uciBfNrow = %d\n", prPfmuTag2->rField.uciBfNrow);
	DBGLOG(RFTEST, ERROR, "MT7668S prPfmuTag2 : prPfmuTag2->rField.u2Reserved5 = %d\n",
	...
	i4Status = kalIoctl(prGlueInfo, wlanoidTxBfAction, &rTxBfActionInfo, sizeof(rTxBfActionInfo), FALSE, FALSE,
			    TRUE, &u4BufLen);
...
INT_32 TxBfProfileTagRead(struct net_device *prNetDev, UINT_8 profileIdx, UINT_8 fgBFer)
{
	...
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileTagRead : profileIdx = 0x%08x\n", profileIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileTagRead : fgBFer = 0x%08x\n", fgBFer);
	...
	i4Status = kalIoctl(prGlueInfo, wlanoidTxBfAction, &rTxBfActionInfo, sizeof(rTxBfActionInfo), TRUE, TRUE, TRUE,
			    &u4BufLen);

	return i4Status;
}

INT_32 StaRecCmmUpdate(struct net_device *prNetDev, UINT_8 ucWlanId, UINT_8 ucBssId, UINT_8 u4Aid,
		       UINT_8 aucMacAddr[MAC_ADDR_LEN])
{
	...
	i4Status = kalIoctl(prGlueInfo, wlanoidStaRecUpdate, &rStaRecCmm, sizeof(CMD_STAREC_COMMON_T), FALSE, FALSE,
			    TRUE, &u4BufLen);

	return i4Status;
}

INT_32 StaRecBfUpdate(struct net_device *prNetDev, STA_REC_BF_UPD_ARGUMENT rStaRecBfUpdArg, UINT_8 aucMemRow[4],
		      UINT_8 aucMemCol[4])
{
	...
	i4Status = kalIoctl(prGlueInfo, wlanoidStaRecBFUpdate, &rStaRecBF, sizeof(CMD_STAREC_BF), FALSE, FALSE, TRUE,
			    &u4BufLen);
...
INT_32 DevInfoUpdate(struct net_device *prNetDev, UINT_8 ucOwnMacIdx, UINT_8 fgBand, UINT_8 aucMacAddr[MAC_ADDR_LEN])
{
	...
	i4Status = kalIoctl(prGlueInfo, wlanoidDevInfoActive, &rDevInfo, sizeof(CMD_DEVINFO_ACTIVE_T), FALSE, FALSE,
			    TRUE, &u4BufLen);
...
INT_32 BssInfoUpdate(struct net_device *prNetDev, UINT_8 ucOwnMacIdx, UINT_8 ucBssIdx, UINT_8 ucBssId[MAC_ADDR_LEN])
{
	...
	i4Status = kalIoctl(prGlueInfo, wlanoidBssInfoBasic, &rBssInfo, sizeof(CMD_BSSINFO_BASIC_T), FALSE, FALSE, TRUE,
			    &u4BufLen);

	return i4Status;
}

INT_32 TxBfProfileDataRead(struct net_device *prNetDev, UINT_8 profileIdx, UINT_8 fgBFer, UINT_8 ucSubCarrIdxMsb,
			   UINT_8 ucSubCarrIdxLsb)
{
	...
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataRead : ucPfmuIdx = 0x%08x\n", profileIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataRead : fgBFer = 0x%08x\n", fgBFer);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataRead : ucSubCarrIdxMsb = 0x%08x\n", ucSubCarrIdxMsb);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataRead : ucSubCarrIdxLsb = 0x%08x\n", ucSubCarrIdxLsb);
...
INT_32 TxBfProfileDataWrite(struct net_device *prNetDev, UINT_8 profileIdx, UINT_16 u2SubCarrIdx, UINT_16 au2Phi[6],
			    UINT_8 aucPsi[6], UINT_8 aucDSnr[4])
{
	...
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : ucPfmuIdx = 0x%08x\n", profileIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : u2SubCarrIdx = 0x%08x\n", u2SubCarrIdx);

	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : au2Phi[0] = 0x%08x\n", au2Phi[0]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : au2Phi[1] = 0x%08x\n", au2Phi[1]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : au2Phi[2] = 0x%08x\n", au2Phi[2]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : au2Phi[3] = 0x%08x\n", au2Phi[3]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : au2Phi[4] = 0x%08x\n", au2Phi[4]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : au2Phi[5] = 0x%08x\n", au2Phi[5]);

	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : aucPsi[0] = 0x%08x\n", aucPsi[0]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : aucPsi[1] = 0x%08x\n", aucPsi[1]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : aucPsi[2] = 0x%08x\n", aucPsi[2]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : aucPsi[3] = 0x%08x\n", aucPsi[3]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : aucPsi[4] = 0x%08x\n", aucPsi[4]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : aucPsi[5] = 0x%08x\n", aucPsi[5]);

	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : aucDSnr[0] = 0x%x\n", aucDSnr[0]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : aucDSnr[1] = 0x%x\n", aucDSnr[1]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : aucDSnr[2] = 0x%x\n", aucDSnr[2]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfileDataWrite : aucDSnr[3] = 0x%x\n", aucDSnr[3]);
...
INT_32 TxBfProfilePnRead(struct net_device *prNetDev, UINT_8 profileIdx)
{
	...
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnRead : ucPfmuIdx = 0x%08x\n", profileIdx);
...
INT_32 TxBfProfilePnWrite(struct net_device *prNetDev, UINT_8 profileIdx, UINT_16 u2bw, UINT_16 au2XSTS[12])
{
	...
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : ucPfmuIdx = 0x%08x\n", profileIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : u2bw = 0x%08x\n", u2bw);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : au2XSTS[0] = 0x%08x\n", au2XSTS[0]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : au2XSTS[1] = 0x%08x\n", au2XSTS[1]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : au2XSTS[2] = 0x%08x\n", au2XSTS[2]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : au2XSTS[3] = 0x%08x\n", au2XSTS[3]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : au2XSTS[4] = 0x%08x\n", au2XSTS[4]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : au2XSTS[5] = 0x%08x\n", au2XSTS[5]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : au2XSTS[6] = 0x%08x\n", au2XSTS[6]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : au2XSTS[7] = 0x%08x\n", au2XSTS[7]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : au2XSTS[8] = 0x%08x\n", au2XSTS[8]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : au2XSTS[9] = 0x%08x\n", au2XSTS[9]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : au2XSTS[10] = 0x%08x\n", au2XSTS[10]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfProfilePnWrite : au2XSTS[11] = 0x%08x\n", au2XSTS[11]);
	...
	memcpy(&rTxBfActionInfo.rProfilePnWrite.ucBuf[0], &au2XSTS[0], sizeof(UINT_16) * 12);
...
)
{
	...
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfSounding : ucSuMu = 0x%08x\n", ucSuMu);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfSounding : ucNumSta = 0x%08x\n", ucNumSta);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfSounding : ucSndInterval = 0x%08x\n", ucSndInterval);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfSounding : ucWLan0 = 0x%08x\n", ucWLan0);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfSounding : ucWLan1 = 0x%08x\n", ucWLan1);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfSounding : ucWLan2 = 0x%08x\n", ucWLan2);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfSounding : ucWLan3 = 0x%08x\n", ucWLan3);
	...
	case MU_PERIODIC_SOUNDING:
		...
		rTxBfActionInfo.rTxBfSoundingStart.rTxBfSounding.rExtCmdExtBfMuSndPeriodicTriggerCtrl.ucStaNum =
			ucNumSta;
		rTxBfActionInfo.rTxBfSoundingStart.rTxBfSounding.rExtCmdExtBfMuSndPeriodicTriggerCtrl
...
INT_32 TxBfSoundingStop(struct net_device *prNetDev)
{
	...
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfSoundingStop\n");
...
INT_32 TxBfTxApply(struct net_device *prNetDev, UINT_8 ucWlanId, UINT_8 fgETxBf, UINT_8 fgITxBf, UINT_8 fgMuTxBf)
{
	...
	DBGLOG(RFTEST, ERROR,
	       "MT7668S TxBfTxApply : ucWlanId = 0x%08x, fgETxBf = 0x%08x,fgITxBf = 0x%08x,fgMuTxBf = 0x%08x\n",
...
INT_32 TxBfPfmuMemAlloc(struct net_device *prNetDev, UINT_8 ucSuMuMode, UINT_8 ucWlanIdx)
{
	...
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfPfmuMemAlloc : ucSuMuMode = 0x%08x, ucWlanIdx = 0x%08x\n", ucSuMuMode,
	       ucWlanIdx);
...
INT_32 TxBfPfmuMemRelease(struct net_device *prNetDev, UINT_8 ucWlanId)
{
	...
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfPfmuMemRelease : ucWlanId = 0x%08x\n", ucWlanId);
...
INT_32 TxBfBssInfoUpdate(struct net_device *prNetDev, UINT_8 ucOwnMacIdx, UINT_8 ucBssIdx, UINT_8 ucBssId[MAC_ADDR_LEN])
{
	...
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfBssInfoUpdate : ucOwnMacIdx = 0x%08x\n", ucOwnMacIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfBssInfoUpdate : ucBssIdx = 0x%08x\n", ucBssIdx);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfBssInfoUpdate : ucBssId[0] = 0x%08x\n", ucBssId[0]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfBssInfoUpdate : ucBssId[1] = 0x%08x\n", ucBssId[1]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfBssInfoUpdate : ucBssId[2] = 0x%08x\n", ucBssId[2]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfBssInfoUpdate : ucBssId[3] = 0x%08x\n", ucBssId[3]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfBssInfoUpdate : ucBssId[4] = 0x%08x\n", ucBssId[4]);
	DBGLOG(RFTEST, ERROR, "MT7668S TxBfBssInfoUpdate : ucBssId[5] = 0x%08x\n", ucBssId[5]);
	...
	COPY_MAC_ADDR(prBssInfo->aucBSSID, ucBssId);
...
INT_32 TxBfManualAssoc(struct net_device *prNetDev, UINT_8 aucMac[MAC_ADDR_LEN], UINT_8 ucType, /* no use */
		       UINT_8 ucWtbl, UINT_8 ucOwnmac, UINT_8 ucMode, UINT_8 ucBw, UINT_8 ucNss, UINT_8 ucPfmuId,
		       UINT_8 ucMarate, UINT_8 ucSpeIdx, UINT_8 ucRca2, UINT_8 ucRv)
{
	...
	i4Status = kalIoctl(prGlueInfo, wlanoidManualAssoc, &rManualAssoc, sizeof(CMD_MANUAL_ASSOC_STRUCT_T), FALSE,
			    FALSE, TRUE, &u4BufLen);
